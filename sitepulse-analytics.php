 ...
 */
     ...
     * events, and discard any pending webhook delivery retries. Discarded
     * retries are not restored on reactivation, but no analytics are lost —
     * an endpoint's next successful delivery always covers everything since
     * its last one.
     *
    ...
    register_deactivation_hook(__FILE__, static function (): void {
        ...
        SitePulseAnalytics\Webhook\WebhookDispatcher::clearAllRetries();
    });
     ...
     *                                   'utm_campaign'. Unknown keys are ignored.
